  ...
  return (
    <div className="container mx-auto p-4">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="text-xl font-bold">EBM Use</div>
          ...
          <table className="min-w-full">
            <thead>
              <tr className="bg-blue-500 text-white">
                <th className="py-2 px-4 text-left">Bottle Number</th>
                <th className="py-2 px-4 text-left">Bottle ID</th>
                <th className="py-2 px-4 text-left">Milk Used (mL)</th>
                <th className="py-2 px-4 text-left">Milk Discarded (mL)</th>
              </tr>
            </thead>
            <tbody>
