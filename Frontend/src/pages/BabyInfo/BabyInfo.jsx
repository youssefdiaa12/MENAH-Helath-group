...
const validationSchema = Yup.object({
  ...
  daysOfLife: Yup.number()
    .typeError("Must be a number")
    .required("Days of life is required"),
  gestationalAgeWeeks: Yup.string().required("Weeks is required"),
  gestationalAgeDays: Yup.string().required("Days is required"),
  correctedGestationalAge: Yup.string().required(
    "Corrected gestational age is required"
  ),
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className={`w-full p-2 border ${
                  formik.touched.babyNameEnglish &&
                  formik.errors.babyNameEnglish
                    ? "border-red-500"
                    : "border-gray-300"
                } rounded`}
              ...
              <div className="flex gap-2">
                <div className="relative flex-1">
                  <select
                    ...
                    className={`w-full p-2 border ${
                      formik.touched.gestationalAgeWeeks &&
                      formik.errors.gestationalAgeWeeks
                        ? "border-red-500"
                        : "border-gray-300"
                    } rounded appearance-none bg-white`}
                  ...
                  >
                    ...
                    {Array.from({ length: 42 }, (_, i) => i + 22).map(
                      (week) => (
            ...
            <div>
              ...
              <input
                ...
                className={`w-full p-2 border ${
                  formik.touched.correctedGestationalAge &&
                  formik.errors.correctedGestationalAge
                    ? "border-red-500"
                    : "border-gray-300"
                } rounded`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                >
                  ...
                  {Array.from({ length: 50 }, (_, i) => (i + 5) / 10).map(
                    (weight) => (
            ...
            <div>
              <div className="relative">
                <select
                  ...
                  className={`w-full p-2 border ${
                    formik.touched.gestationalAgeDays &&
                    formik.errors.gestationalAgeDays
                      ? "border-red-500"
                      : "border-gray-300"
                  } rounded appearance-none bg-white`}
