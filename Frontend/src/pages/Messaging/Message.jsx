...
const mockInboxMessages = [
  { id: 1, from: "Heba Tarek", message: "Please check...", date: "27/04/2025", read: false },
  { id: 2, from: "Yasmeen Essam", message: "Please check...", date: "27/04/2025", read: true },
  { id: 3, from: "Nada Shaker", message: "Please check...", date: "27/04/2025", read: false },
  { id: 4, from: "Nada Shaker", message: "Please check...", date: "27/04/2025", read: true },
  { id: 5, from: "Nada Shaker", message: "Please check...", date: "27/04/2025", read: false },
  {
    id: 6,
    from: "Nurse Mariam",
...
const mockAllMessages = [
  { id: 7, from: "Heba Tarek", message: "Please check...", date: "27/04/2025", read: false },
  { id: 8, from: "Yasmeen Essam", message: "Please check...", date: "27/04/2025", read: true },
  { id: 9, from: "Nada Shaker", message: "Please check...", date: "27/04/2025", read: false },
  { id: 10, from: "Nada Shaker", message: "Please check...", date: "27/04/2025", read: true },
  { id: 11, from: "Nada Shaker", message: "Please check...", date: "27/04/2025", read: false },
  { id: 11, from: "Nada Shaker", message: "Please check...", date: "27/04/2025", read: false },
...
const MessageCenter = () => {
  ...
  const currentInboxMessages = mockInboxMessages.slice(indexOfFirstInboxMessage, indexOfLastInboxMessage)
  ...
  const currentAllMessages = mockAllMessages.slice(indexOfFirstAllMessage, indexOfLastAllMessage)
  const totalAllMessagesPages = Math.ceil(mockAllMessages.length / messagesPerPage)

  const paginateAllMessages = (pageNumber) => setAllMessagesCurrentPage(pageNumber)

  return (
    <div className="max-w-8xl mx-auto p-4">
      <h1 className="text-2xl font-semibold text-center mb-6">Messaging Center</h1>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6">
        ...
        <Formik initialValues={{ recipient: "", message: "" }} validationSchema={MessageSchema} onSubmit={handleSubmit}>
              ...
              <div>
                <Field
                  ...
                  className={`w-full p-3 border ${
                    errors.recipient && touched.recipient ? "border-red-500" : "border-gray-300"
                  } rounded-md`}
                />
                <ErrorMessage name="recipient" component="div" className="text-red-500 text-sm mt-1" />
              </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6">
        ...
        >
          ...
          <button className="text-blue-500">
            {inboxExpanded ? <ChevronDown className="h-5 w-5" /> : <ChevronRight className="h-5 w-5" />}
          </button>
        </div>

        <p className="text-gray-600 mt-1">This is your personal inbox. You can view messages sent directly to you.</p>
          ...
          <div className="mt-4">
            ...
            <div className="flex justify-center mt-4">
              <nav className="flex items-center">
                <button
                  onClick={() => paginateInbox(inboxCurrentPage > 1 ? inboxCurrentPage - 1 : 1)}
                ...
                {[...Array(totalInboxPages).keys()].map((number) => (
                  <button
                    ...
                    className={`px-3 py-1 ${
                      inboxCurrentPage === number + 1 ? "bg-blue-500 text-white" : "bg-gray-200"
                    }`}
                  >
                    {number + 1}
                  </button>
                ...
                {totalInboxPages > 5 && <span className="px-3 py-1 bg-gray-200">...</span>}

                {totalInboxPages > 5 && (
                  <>
                    <button onClick={() => paginateInbox(9)} className="px-3 py-1 bg-gray-200">
                      9
                    </button>
                    <button onClick={() => paginateInbox(10)} className="px-3 py-1 bg-gray-200">
                      10
                    </button>
                  </>
                )}
                ...
                <button
                  onClick={() =>
                    paginateInbox(inboxCurrentPage < totalInboxPages ? inboxCurrentPage + 1 : totalInboxPages)
                  }
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        ...
        >
          ...
          <button className="text-blue-500">
            {allMessagesExpanded ? <ChevronDown className="h-5 w-5" /> : <ChevronRight className="h-5 w-5" />}
          </button>
        </div>
        ...
        {allMessagesExpanded && (
          <div className="mt-4">
            ...
            <div className="flex justify-center mt-4">
              <nav className="flex items-center">
                <button
                  onClick={() => paginateAllMessages(allMessagesCurrentPage > 1 ? allMessagesCurrentPage - 1 : 1)}
                  className="px-3 py-1 bg-gray-200 rounded-l-md"
                ...
                {[...Array(totalAllMessagesPages).keys()].map((number) => (
                  <button
                    ...
                    className={`px-3 py-1 ${
                      allMessagesCurrentPage === number + 1 ? "bg-blue-500 text-white" : "bg-gray-200"
                    }`}
                  >
                    {number + 1}
                  </button>
                ...
                {totalAllMessagesPages > 5 && <span className="px-3 py-1 bg-gray-200">...</span>}

                {totalAllMessagesPages > 5 && (
                  <>
                    <button onClick={() => paginateAllMessages(9)} className="px-3 py-1 bg-gray-200">
                      9
                    </button>
                    <button onClick={() => paginateAllMessages(10)} className="px-3 py-1 bg-gray-200">
                      10
                    </button>
                  </>
                )}
          ...
          <div className="bg-white rounded-lg p-6 max-w-md w-full">
            ...
            <div className="space-y-3">
              ...
              <div className="flex space-x-3 mt-6">
                <button className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-md">Reply</button>
                <button
                  onClick={() => {
