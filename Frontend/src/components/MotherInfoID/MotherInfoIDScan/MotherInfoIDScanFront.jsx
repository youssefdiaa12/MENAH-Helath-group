...
const MotherInfoIDScanFront = () => {
  ...
  const saveImage = () => {
    ...
    const fileName = `Mother_ID_Scan_Front_${babyName}_${babyMRN}.png`;
  ...
  return (
    <div style={{ width: '50%', padding: '10px', boxSizing: 'border-box', border: '1px solid lightgray' }}>
      <h3 style={{ textAlign: 'left' }}>Scan Front Side of Mother ID</h3>
...
export default MotherInfoIDScanFront;
