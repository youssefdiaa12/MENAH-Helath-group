...
const MotherInfoIDUploadBack = () => {
  ...
  const saveImage = () => {
    ...
    const fileName = `Mother_ID_Upload_Back_${babyName}_${babyMRN}.png`;
  ...
  return (
    <div style={{ width: '50%', padding: '10px', boxSizing: 'border-box', border: '1px solid lightgray' }}>
      <h3>Upload Back Side of Mother ID</h3>

      <input type="file" accept="image/*" onChange={handleFileChange} />

      {uploadedImage && (
        <div style={{ marginTop: '10px' }}>
          <img src={uploadedImage} alt="Uploaded Back ID" style={{ width: '300px', height: '200px' }} />
          <div style={{ marginTop: '10px' }}>
...
export default MotherInfoIDUploadBack;
