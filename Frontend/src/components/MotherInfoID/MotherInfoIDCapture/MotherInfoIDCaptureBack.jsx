...
const MotherInfoIDCaptureBack = () => {
  ...
  const saveImage = () => {
    ...
    const fileName = `Mother_ID_Capture_Back_${babyName}_${babyMRN}.png`;
  ...
  return (
    <div style={{ width: '50%', padding: '10px', boxSizing: 'border-box', border: '1px solid lightgray' }}>
      <h3 style={{ textAlign: 'left' }}>Capture Back Side of Mother ID</h3>
...
export default MotherInfoIDCaptureBack;
