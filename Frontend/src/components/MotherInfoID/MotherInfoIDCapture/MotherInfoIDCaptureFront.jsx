...
const MotherInfoIDCaptureFront = () => {
  ...
  const saveImage = () => {
    ...
    const fileName = `Mother_ID_Capture_Front_${babyName}_${babyMRN}.png`;
  ...
  return (
    <div style={{ width: '50%', padding: '10px', boxSizing: 'border-box', border: '1px solid lightgray' }}>
      <h3 style={{ textAlign: 'left' }}>Capture Front Side of Mother ID</h3>
      ...
      {capturedImage && (
        <div style={{ marginTop: '10px' }}>
          ...
          <img src={capturedImage} alt="Captured ID" style={{ width: '300px', height: '200px' }} />
          <div style={{ marginTop: '10px' }}>
...
export default MotherInfoIDCaptureFront;
