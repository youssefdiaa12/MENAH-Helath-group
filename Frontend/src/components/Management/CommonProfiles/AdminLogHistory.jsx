// C:\Users\yahya\Halebi\src\components\Management\Admin\AdminLogHistory.jsx
...
const AdminLogHistory = () => {
  ...
  useEffect(() => {
    const logins = JSON.parse(localStorage.getItem('adminLoginHistory')) || [];
    const logouts = JSON.parse(localStorage.getItem('adminLogoutHistory')) || [];
