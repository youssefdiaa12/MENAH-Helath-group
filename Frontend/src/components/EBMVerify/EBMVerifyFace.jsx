  ...
  const handleMatch = () => {
    ...
    if (qrCodeOnBottle && qrCodeOnBottle === qrCodeInSystem) {
      ...
      localStorage.setItem('pendingNurseVerification', JSON.stringify({
        ...
        method: 'FacePhoto Verification',
        requestedBy: nurse1Name
      }));

      alert("Face matched. Nurse 2 will be notified to verify.");
      setAwaitingVerification(true);
    } else {
      alert("Face and QR code do not match. Please try another method.");
    }
  };
