  ...
  const handleMatch = () => {
    ...
    if (qrCodeOnBottle && qrCodeOnBottle === qrCodeInSystem) {
      ...
      localStorage.setItem('pendingNurseVerification', JSON.stringify({
        ...
        method: 'RetinaPrint Verification',
        requestedBy: nurse1Name
      }));

      alert("Retina print matched. Nurse 2 will be notified to verify.");
      setAwaitingVerification(true);
    } else {
      alert("Retina print and QR code do not match. Please try another method.");
    }
  };
...
export default EBMVerifyRetina;
