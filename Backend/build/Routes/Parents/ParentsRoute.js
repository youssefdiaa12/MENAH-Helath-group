...
ParentRouter.post("/babies", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield (0, ParentsController_1.getParentBabies)(req.body.username);
        res.json(response);
    }
    catch (error) {
        console.error(error);
...
ParentRouter.post("/EBM", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield (0, ParentsController_1.getParentEBM)(req.body.page, req.body.username);
        res.json(response);
    }
    catch (error) {
        console.error(error);
...
ParentRouter.post("/calculations", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield (0, ParentsController_1.getCalculations)(req.body.username);
        res.json(response);
    }
    catch (error) {
        console.error(error);
