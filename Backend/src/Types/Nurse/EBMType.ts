...
export function validateEbmInfo(data: ebmInfo): { isValid: boolean; message: string } {
    // Validate 'order'
...
export function validateBottleUsageInfo(data: BottleUsageInfo): { isValid: boolean; message: string } {
